...
1. What is the DOM?
The DOM is the document object model. It represents the structure of the various html elements, and their relationship to one another.
2. What is an event?
An event is a something that happens, either from the browser or the user.
3. What is an event listener?
An event listener executes code when an event interacts with it.
4. Why would we convert a NodeList into an Array?
So that we can iterate over its elements.
5. What is a component?
a component is preconstructed structure of html elements. generally
an implementation of something like a "form", or "header", or "carousel"
